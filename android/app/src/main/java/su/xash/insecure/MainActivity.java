...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String PREF_NAME = "InsecurePrefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runButton.setOnClickListener(v -> {
            ...
            saveArgs(userArgs);
            startGame(userArgs.trim() + " -dll @insecure +cl_lw 0");
        });
        ...
        infoButton.setOnClickListener(v -> {
            ...
            // For some siemON fans (aaa siemon thanks for the port 🙏🙏) ahahaha
            String content = "Ported by <a href='https://discord.com/users/552479599980970005'>@elinsrc</a><br>" +
                             "Built by <a href='https://discord.com/users/811503620860280833'>@yalnie</a><br>" +
                             "Huge thanks to <a href='https://github.com/FWGS'>Flying With Gauss</a>";
            
            message.setText(android.text.Html.fromHtml(content, android.text.Html.FROM_HTML_MODE_LEGACY));
            message.setMovementMethod(android.text.method.LinkMovementMethod.getInstance());
            
            message.setPadding(60, 40, 60, 0);
            ...
            new MaterialAlertDialogBuilder(this)
                    ...
                    .setNegativeButton("GitHub", (dialog, which) -> {
                        String url = "https://github.com/Elinsrc/hlsdk-portable/tree/insecure";
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
                    })
                    .setNeutralButton("Discord", (dialog, which) -> {
                        // hahayoutookind discord
                        String url = "https://discord.gg/kBWCHAfFqA"; 
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url)));
                    })
                    .show();
        });
